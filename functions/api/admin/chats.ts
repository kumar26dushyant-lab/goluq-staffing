...
const PARTNER_CARDS = [
  ...
  { id: "aff_boss", name: "Partner — become your own boss" },
  { id: "aff_playbook", name: "Partner — the playbook, step by step" },
  { id: "aff_yourway", name: "Partner — bring clients your own way" },
];
